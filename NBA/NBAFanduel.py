...
def run_nba(day,month,year):
        ...
        dates = sample_frame['URL'].map(lambda x: x.replace('http://rotoguru1.com/cgi-bin/hyday.pl?game=fd&mon=', '') \
                                     .replace('&year=', '/') \
                                     .replace('&day=', '/'))
        ...
        sample_frame.columns = ['Date,', 'Position', 'Name', 'Fanduel_Points', 'Fanduel_Price', 'Team', 'Opponent',
                                'Score', 'Minutes', 'Stats']
        ...
        stats_split['Rebounds'] = stats_split[3].str.extract(pat='(.?.rb)').fillna(
            stats_split[2].str.extract(pat='(.?.rb)'))
        # removing signifier
        ...
        stats_split['Assists'] = stats_split[4].str.extract(pat='(.?.as)').fillna(
            stats_split[3].str.extract(pat='(.?.as)')).fillna(stats_split[2].str.extract(pat='(.?.as)'))
        # removing signifier
        ...
        stats_split['Steals'] = stats_split[5].str.extract(pat='(.?.st)').fillna(
            stats_split[4].str.extract(pat='(.?.st)')).fillna(stats_split[3].str.extract(pat='(.?.st)')).fillna(
            stats_split[2].str.extract(pat='(.?.st)'))
        # removing signifier
        ...
        stats_split['Blocks'] = stats_split[6].str.extract(pat='(.?.bl)').fillna(
            stats_split[5].str.extract(pat='(.?.bl)')) \
            .fillna(stats_split[4].str.extract(pat='(.?.bl)')).fillna(stats_split[3].str.extract(pat='(.?.bl)')).fillna(
            stats_split[2].str.extract(pat='(.?.bl)'))
        # removing signifier
        ...
        stats_split['Turnovers'] = stats_split[7].str.extract(pat='(.?.to)').fillna(
            stats_split[6].str.extract(pat='(.?.to)')).fillna(stats_split[5].str.extract(pat='(.?.to)')) \
            .fillna(stats_split[4].str.extract(pat='(.?.to)')).fillna(stats_split[3].str.extract(pat='(.?.to)')).fillna(
            stats_split[2].str.extract(pat='(.?.to)'))
        # removing signifier
        ...
        stats_split['3pts'] = stats_split[8].str.extract(pat='(.?.trey)').fillna(
            stats_split[7].str.extract(pat='(.?.trey)')) \
            .fillna(stats_split[6].str.extract(pat='(.?.trey)')).fillna(stats_split[5].str.extract(pat='(.?.trey)')) \
            .fillna(stats_split[4].str.extract(pat='(.?.trey)')).fillna(
            stats_split[3].str.extract(pat='(.?.trey)')).fillna(stats_split[2].str.extract(pat='(.?.to)'))
        # removing signifier
        ...
        stats_split['Field_Goals'] = stats_split[9].str.extract(pat='(.?.?.?.fg)').fillna(
            stats_split[8].str.extract(pat='(.?.?.?.fg)')).fillna(stats_split[7].str.extract(pat='(.?.?.?.fg)')) \
            .fillna(stats_split[6].str.extract(pat='(.?.?.?.fg)')).fillna(stats_split[5].str.extract(pat='(.?.?.?.fg)')) \
            .fillna(stats_split[4].str.extract(pat='(.?.?.?.fg)')).fillna(
            stats_split[3].str.extract(pat='(.?.?.?.fg)')).fillna(stats_split[2].str.extract(pat='(.?.?.?.fg)'))
        # removing signifier
        stats_split['Field_Goals'] = stats_split['Field_Goals'].str.replace('fg', '')
        # trying now for Free throws
        stats_split['Free_Throws'] = stats_split[10].str.extract(pat='(.?.?.?.ft)').fillna(
            stats_split[9].str.extract(pat='(.?.?.?.ft)')).fillna(stats_split[8].str.extract(pat='(.?.?.?.ft)')) \
            .fillna(stats_split[7].str.extract(pat='(.?.?.?.ft)')).fillna(
            stats_split[6].str.extract(pat='(.?.?.?.ft)')).fillna(stats_split[5].str.extract(pat='(.?.?.?.ft)')) \
            .fillna(stats_split[4].str.extract(pat='(.?.?.?.ft)')).fillna(
            stats_split[3].str.extract(pat='(.?.?.?.ft)')).fillna(stats_split[2].str.extract(pat='(.?.?.?.ft)'))
        # removing signifier
        ...
        df1[['Points', 'Rebounds', 'Assists', 'Steals', 'Blocks', 'Turnovers',
             ...
             'Free_Throws_Attempted', 'Free_Throw%']] = stats_split[
